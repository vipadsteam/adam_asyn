 ...
 *
 */
public class DoFailTasker<T1, T2> extends AbsTasker<T1, T2> {

	private static final Log log = LogFactory.getLog(DoFailTasker.class);

	public static final String TYPE = "fail";

	public DoFailTasker(IService<T1, T2> service, ILogService logService, IServiceBefore<T1, T2> serviceBefore) {
