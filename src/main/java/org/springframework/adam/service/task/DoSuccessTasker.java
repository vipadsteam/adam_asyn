 ...
 *
 */
public class DoSuccessTasker<T1, T2> extends AbsTasker<T1, T2> {

	private static final Log log = LogFactory.getLog(DoSuccessTasker.class);

	public static final String TYPE = "success";

	public DoSuccessTasker(IService<T1, T2> service, ILogService logService, IServiceBefore<T1, T2> serviceBefore) {
